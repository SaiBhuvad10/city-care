...
<body>
    ...
    <header class="main-header">
        <div class="header-container">
            <div class="logo"><a href="index.php">City Care Hospital</a></div>
            <nav class="navbar">
                <ul class="nav-links">
                    ...
                    <li><a href="medicines.php" class="active">Medical</a></li>
                </ul>
            </nav>
            <div class="header-right"><a href="#" class="btn-book">Book Appointment</a></div>
        </div>
    </header>
