    ...
    <div class="max-w-xl w-full bg-white rounded-[3rem] p-12 shadow-2xl">
        <div class="text-center mb-10">
            <a href="index.php" class="inline-flex items-center gap-2 mb-6 group">
                <div
                    class="w-12 h-12 bg-primary rounded-full flex items-center justify-center text-white transition-transform group-hover:rotate-12">
        ...
        <form class="space-y-6" method="POST" action="register.php">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <i data-lucide="user"
                            class="absolute left-5 top-1/2 -translate-y-1/2 text-secondary/40 group-focus-within:text-primary transition-colors"
                            size="20"></i>
            ...
            <div class="flex items-start gap-3 ml-1">
                <input type="checkbox" required
                    class="mt-1 w-5 h-5 rounded-lg border-none bg-surface-soft text-primary focus:ring-primary/20" />
                <p class="text-sm text-secondary/60 leading-relaxed">
                    I agree to the <a href="#" class="text-primary font-bold hover:underline">Terms of Service</a> and
